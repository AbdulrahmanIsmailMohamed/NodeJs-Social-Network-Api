...
describe("Post Testing", () => {
  ...
  describe("POST /api/v1/comments/:postId", () => {
    it("should create comment", async () => {
      const res = await server
        .post("/api/v1/comments/6473b459ebf94c9dbfa6fbd0")
    ...
    it("should not create comment if postId not exist", async () => {
      const res = await server
        .post("/api/v1/comments/6473b459ebf94c9dbfa6fbd1")
        .set("Authorization", `Bearer ${token}`)
        .send(comment);
  ...
  describe("GET /api/v1/comments/get/:postId", () => {
    it("should get comments of posts", async () => {
      const res = await server
        .get("/api/v1/comments/get/6473b459ebf94c9dbfa6fbd0")
        .set("Authorization", `Bearer ${token}`);
    ...
    it("should not get comments of post if user not login", async () => {
      const res = await server.post(
        "/api/v1/comments/get/6473b459ebf94c9dbfa6fbd0"
      );
  ...
  describe("Get /api/v1/comments/:id", () => {
    it("should create comment", async () => {
      const res = await server
        .get("/api/v1/comments/647e72b67ae04a8abbd2ef2f")
        .set("Authorization", `Bearer ${token}`);
    ...
    it("should not get comment if comment id not exist", async () => {
      const res = await server
        .get("/api/v1/comments/6473b459ebf94c9dbfa6fbd1")
        .set("Authorization", `Bearer ${token}`)
        .send(comment);
  ...
  describe("PATCH /api/v1/comments/:id", () => {
    it("should update comment", async () => {
      const res = await server
        .patch("/api/v1/comments/647e72b67ae04a8abbd2ef2f")
        .set("Authorization", `Bearer ${token}`)
        .send(updateComment);
  ...
  describe("DELETE /api/v1/comments/:id", () => {
    it("should delete comment", async () => {
      const res = await server
        .delete("/api/v1/comments/647e72b67ae04a8abbd2ef2f")
        .set("Authorization", `Bearer ${token}`);
